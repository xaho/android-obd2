 ...
 *
 */
public class InstantSpeedCommand extends ObdCommand implements SystemOfUnits {
     ...
     * Copy ctor.
     *
     * @param other a {@link InstantSpeedCommand} object.
     */
    public InstantSpeedCommand(InstantSpeedCommand other) {
        super(other);
    }
